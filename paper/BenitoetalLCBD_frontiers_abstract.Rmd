...
```{r echo=FALSE, fig.cap="Contribution of replacement (LCBDrepl) and richness (LCBDrich) components to beta diversity for the six investigated lake cores (arranged by increased latitude)", out.width = '100%'}
knitr::include_graphics("../figures/LCBDtimeseries_new.png")
```
